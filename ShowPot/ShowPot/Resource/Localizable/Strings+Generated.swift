...
public enum Strings {
  ...
  /// 3초만에 로그인하기
  public static let bottomSheetLoginButtonTitle = Strings.tr("Localizable", "bottom_sheet_login_button_title", fallback: "3초만에 로그인하기")
  /// 로그인 후 좋아하는
  /// 장르를 구독해보세요!
  ...
  /// 해제하기
  public static let myShowAlarmBottomsheetButton2 = Strings.tr("Localizable", "my_show_alarm_bottomsheet_button_2", fallback: "해제하기")
  /// 알림
  public static let myShowAlarmBottomsheetTitle = Strings.tr("Localizable", "my_show_alarm_bottomsheet_title", fallback: "알림")
  /// 해당 시간 선택은 불가능해요
  public static let myShowDisenabledTitle = Strings.tr("Localizable", "my_show_disenabled_title", fallback: "해당 시간 선택은 불가능해요")
  /// 공연 정보 보러가기
  public static let myShowEmptyButtonTitle = Strings.tr("Localizable", "my_show_empty_button_title", fallback: "공연 정보 보러가기")
  /// 알림 설정한
  /// 공연이 없어요
  public static let myShowEmptyTitle = Strings.tr("Localizable", "my_show_empty_title", fallback: "알림 설정한\n공연이 없어요")
  /// 알림 설정한 공연
  public static let myShowNavigationTitle = Strings.tr("Localizable", "my_show_navigation_title", fallback: "알림 설정한 공연")
  /// 티켓팅 알림을 언제 받으실건가요?
  public static let myShowTicketBottomsheetTitle = Strings.tr("Localizable", "my_show_ticket_bottomsheet_title", fallback: "티켓팅 알림을 언제 받으실건가요?")
  /// 알림 시간 변경하기
  public static let myShowTicketButtonTitle = Strings.tr("Localizable", "my_show_ticket_button_title", fallback: "알림 시간 변경하기")
  /// 쇼팟 시작하기
  ...
  /// 최신버전 입니다
  public static let settingVersionUpToDateTitle = Strings.tr("Localizable", "setting_version_up_to_date_title", fallback: "최신버전 입니다")
  /// 아티스트 정보
